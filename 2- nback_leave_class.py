...
# MODEL_NAMEs = [ 'C2D','C2DSpatTem1', 'C2DSpatTem2']

EXP_TYPEs = ['BLs_WL2','WL1_WL2_WL3','BLs_WL2_WL3','BLs_WL1_WL2_WL3']
...
#             r'selected_dataset_eeg_power_filt_datafiltset_aslogic_phase_2_IQR_new_iqr_window_40_30',
#         ]



MODEL_NAMEs = ['C2D']
# EXP_TYPEs = ['BLs_WL2_WL3','BLs_WL1_WL2_WL3']
files = [r'selected_dataset_eeg_power_filt_datafiltset_aslogic_phase_2_IQR_new_iqr_window_40_30']
channel_id = 0
